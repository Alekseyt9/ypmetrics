...
func easyjson2220f231DecodeGithubComAlekseyt9YpmetricsInternalCommon(in *jlexer.Lexer, out *Metrics) {
...
func easyjson2220f231EncodeGithubComAlekseyt9YpmetricsInternalCommon(out *jwriter.Writer, in Metrics) {
	out.RawByte('{')
	first := true
	_ = first
	{
